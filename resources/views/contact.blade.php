...
@section('main-content')
    ...
    <!-- contact starts -->
    <section class="contact-main pb-8" style="background-image: url({{ asset('assets/images/testimonial-1.png') }});">
        <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="info-item bg-grey px-4 py-5 border-all text-center">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="mb-0">19 By Pass Main Street, Dubai, BC 22196</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="info-item bg-grey px-4 py-5 border-all text-center">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="m-0">Email Address: VeloxEvents@mail.com</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 mb-4">
                            <div class="info-item bg-grey px-4 py-5 border-all text-center">
                                ...
                                <div class="info-content ps-4">
                                    ...
                                    <p class="m-0">Feb 12 - 14 Feb 2024 Starts 09:00am to 06:00 pm</p>
                                </div>
                            </div>
                        </div>
                    </div>
