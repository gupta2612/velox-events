@extends('layout.main')
@section('title')
<title>Fabrication, Backdrop & Set Design || {{ config('app.name') }}</title>
@endsection
        ...
        <div class="breadcrumb-outer">
            <div class="container">
                <div class="breadcrumb-content text-center pt-14 pb-2">
                    ...
                    <h1 class="mb-0 white">Fabrication, Backdrop & Set design</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row d-flex align-items-center justify-content-between">
                    <div class="col-lg-5 pe-4">
                        <div class="about-content section-title text-lg-start text-center mb-4">
                            ...
                            <h4 class="theme"> Fabrication, Backdrop & Set design</h4>
